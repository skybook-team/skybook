...
const S: Record<string, ScheduledFlight[]> = {
  ...
  'SFO-BNA': [
    // ── Nonstop ──────────────────────────────────────────────────────────
    { code: 'UA', num:  499, dep: '09:15', dur: 276, ac: 'Boeing 737-800',   fare: 315 },
    { code: 'UA', num: 2281, dep: '16:30', dur: 260, ac: 'Airbus A319',      fare: 325, days:[0,5] },
    { code: 'UA', num: 1815, dep: '23:59', dur: 278, ac: 'Boeing 737 MAX 9', fare: 305 },
    { code: 'UA', num: 1401, dep: '22:57', dur: 257, ac: 'Boeing 737 MAX 8', fare: 300, days:[0,5] },
    { code: 'WN', num:  528, dep: '10:35', dur: 250, ac: 'Boeing 737-800',   fare: 270, days:[1,4,5] },
    { code: 'WN', num: 1172, dep: '10:05', dur: 245, ac: 'Boeing 737-700',   fare: 265, days:[0,5] },
    { code: 'WN', num: 1172, dep: '08:10', dur: 250, ac: 'Boeing 737 MAX 8', fare: 260, days:[6] },
    { code: 'WN', num: 3634, dep: '22:50', dur: 255, ac: 'Boeing 737-700',   fare: 260 },
    { code: 'WN', num: 1683, dep: '23:05', dur: 265, ac: 'Boeing 737 MAX 8', fare: 265, days:[1,2,3,4,5,6] },
    // ── 1-stop ────────────────────────────────────────────────────────────
    { code: 'AA', num: 2251, dep: '06:45', dur: 541, ac: 'Boeing 737-800',   fare: 245, stops: 1, via: 'DFW' },
    { code: 'AA', num: 1153, dep: '12:36', dur: 394, ac: 'Airbus A321',      fare: 265, stops: 1, via: 'DFW' },
  ...
  'BNA-SFO': [
    // ── Nonstop ──────────────────────────────────────────────────────────
    { code: 'UA', num: 1578, dep: '06:10', dur: 250, ac: 'Boeing 737 MAX 8', fare: 305 },
    { code: 'UA', num:  626, dep: '08:15', dur: 242, ac: 'Boeing 737 MAX 8', fare: 315 },
    { code: 'UA', num: 2464, dep: '08:30', dur: 245, ac: 'Boeing 737 MAX 8', fare: 310, days:[0,4,5,6] },
    { code: 'UA', num:  298, dep: '14:54', dur: 288, ac: 'Boeing 737-800',   fare: 325 },
    { code: 'UA', num: 1295, dep: '18:10', dur: 251, ac: 'Boeing 737-800',   fare: 315, days:[0,1,2,3,4,5] },
    { code: 'UA', num: 2673, dep: '18:35', dur: 241, ac: 'Boeing 737 MAX 8', fare: 315, days:[0,1,4,5] },
    { code: 'WN', num: 1474, dep: '08:20', dur: 255, ac: 'Boeing 737 MAX 8', fare: 270, days:[6] },
    { code: 'WN', num: 1689, dep: '08:50', dur: 295, ac: 'Boeing 737-700',   fare: 265, days:[0] },
    { code: 'WN', num: 1330, dep: '11:45', dur: 240, ac: 'Boeing 737-800',   fare: 275, days:[0,1,2,5] },
    { code: 'WN', num:  678, dep: '12:20', dur: 245, ac: 'Boeing 737-700',   fare: 270, days:[1,4,5] },
    { code: 'WN', num:  647, dep: '14:45', dur: 250, ac: 'Boeing 737 MAX 8', fare: 275, days:[1,4,5] },
    { code: 'WN', num:  647, dep: '12:50', dur: 250, ac: 'Boeing 737 MAX 8', fare: 270, days:[6] },
    { code: 'WN', num:  673, dep: '17:15', dur: 280, ac: 'Boeing 737-800',   fare: 265, days:[1,4,5] },
    { code: 'WN', num:  673, dep: '18:25', dur: 280, ac: 'Boeing 737-800',   fare: 260, days:[6] },
    { code: 'WN', num:  673, dep: '13:45', dur: 280, ac: 'Boeing 737 MAX 8', fare: 265, days:[0] },
    { code: 'WN', num:  760, dep: '19:15', dur: 275, ac: 'Boeing 737 MAX 8', fare: 265, days:[1,4,5] },
    { code: 'WN', num: 1010, dep: '13:25', dur: 295, ac: 'Boeing 737 MAX 8', fare: 260, days:[6] },
    { code: 'WN', num: 1010, dep: '18:30', dur: 295, ac: 'Boeing 737 MAX 8', fare: 260, days:[0] },
    // ── 1-stop ────────────────────────────────────────────────────────────
    { code: 'WN', num:  485, dep: '05:15', dur: 375, ac: 'Boeing 737-800',   fare: 215, stops: 1, via: 'PHX', days:[1,4,5] },
    { code: 'WN', num: 3239, dep: '05:00', dur: 375, ac: 'Boeing 737-800',   fare: 215, stops: 1, via: 'PHX', days:[0] },
    { code: 'WN', num:  540, dep: '07:35', dur: 395, ac: 'Boeing 737-700',   fare: 220, stops: 1, via: 'PHX', days:[0,5] },
    { code: 'AA', num: 1937, dep: '05:01', dur: 454, ac: 'Boeing 737-800',   fare: 245, stops: 1, via: 'DFW' },
    { code: 'AA', num: 1309, dep: '05:30', dur: 527, ac: 'Airbus A321',      fare: 240, stops: 1, via: 'DFW' },
    { code: 'AA', num: 2741, dep: '14:18', dur: 408, ac: 'Boeing 737-800',   fare: 245, stops: 1, via: 'DFW' },
    { code: 'DL', num: 2847, dep: '06:15', dur: 450, ac: 'Airbus A220-300',  fare: 245, stops: 1, via: 'SLC' },
    { code: 'UA', num: 3281, dep: '06:30', dur: 425, ac: 'Boeing 737-900',   fare: 235, stops: 1, via: 'IAH' },
    { code: 'UA', num: 2437, dep: '07:40', dur: 454, ac: 'Airbus A320neo',   fare: 240, stops: 1, via: 'DEN' },
