...
const S: Record<string, ScheduledFlight[]> = {
  ...
  'SFO-BNA': [
    // ── Nonstop ──────────────────────────────────────────────────────────
    { code: 'UA', num:  499, dep: '09:15', dur: 276, ac: 'Boeing 737-800',   fare: 152 },
    { code: 'UA', num: 2281, dep: '16:30', dur: 260, ac: 'Airbus A319',      fare: 156, days:[0,5] },
    { code: 'UA', num: 1815, dep: '23:59', dur: 278, ac: 'Boeing 737 MAX 9', fare: 149 },
    { code: 'UA', num: 1401, dep: '22:57', dur: 257, ac: 'Boeing 737 MAX 8', fare: 148, days:[0,5] },
    { code: 'WN', num:  528, dep: '10:35', dur: 250, ac: 'Boeing 737-800',   fare: 133, days:[1,4,5] },
    { code: 'WN', num: 1172, dep: '10:05', dur: 245, ac: 'Boeing 737-700',   fare: 131, days:[0,5] },
    { code: 'WN', num: 1172, dep: '08:10', dur: 250, ac: 'Boeing 737 MAX 8', fare: 129, days:[6] },
    ...
    { code: 'UA', num: 1631, dep: '12:15', dur: 507, ac: 'Airbus A320neo',   fare:  86, stops: 1, via: 'DEN' },
    { code: 'WN', num: 4721, dep: '06:05', dur: 590, ac: 'Boeing 737-800',   fare:  74, stops: 1, via: 'PHX' },
    { code: 'WN', num: 3817, dep: '11:00', dur: 625, ac: 'Boeing 737-800',   fare:  72, stops: 1, via: 'PHX' },
    { code: 'WN', num: 4293, dep: '14:35', dur: 425, ac: 'Boeing 737-800',   fare:  76, stops: 1, via: 'PHX' },
    { code: 'F9', num: 1871, dep: '21:43', dur: 701, ac: 'Airbus A320neo',   fare:  69, stops: 1, via: 'DEN' },
  ],
  'BNA-SFO': [
    // ── Nonstop ──────────────────────────────────────────────────────────
    { code: 'UA', num: 1578, dep: '06:10', dur: 250, ac: 'Boeing 737 MAX 8', fare: 149 },
    { code: 'UA', num:  626, dep: '08:15', dur: 242, ac: 'Boeing 737 MAX 8', fare: 154 },
    { code: 'UA', num: 2464, dep: '08:30', dur: 245, ac: 'Boeing 737 MAX 8', fare: 151, days:[0,4,5,6] },
    { code: 'UA', num:  298, dep: '14:54', dur: 288, ac: 'Boeing 737-800',   fare: 158 },
    { code: 'UA', num: 1295, dep: '18:10', dur: 251, ac: 'Boeing 737-800',   fare: 153, days:[0,1,2,3,4,5] },
    { code: 'UA', num: 2673, dep: '18:35', dur: 241, ac: 'Boeing 737 MAX 8', fare: 151, days:[0,1,4,5] },
    { code: 'WN', num: 1474, dep: '08:20', dur: 255, ac: 'Boeing 737 MAX 8', fare: 133, days:[6] },
    { code: 'WN', num: 1689, dep: '08:50', dur: 295, ac: 'Boeing 737-700',   fare: 131, days:[0] },
    { code: 'WN', num: 1330, dep: '11:45', dur: 240, ac: 'Boeing 737-800',   fare: 135, days:[0,1,2,5] },
    { code: 'WN', num:  678, dep: '12:20', dur: 245, ac: 'Boeing 737-700',   fare: 132, days:[1,4,5] },
    { code: 'WN', num:  647, dep: '14:45', dur: 250, ac: 'Boeing 737 MAX 8', fare: 135, days:[1,4,5] },
    { code: 'WN', num:  647, dep: '12:50', dur: 250, ac: 'Boeing 737 MAX 8', fare: 133, days:[6] },
    { code: 'WN', num:  673, dep: '17:15', dur: 280, ac: 'Boeing 737-800',   fare: 131, days:[1,4,5] },
    { code: 'WN', num:  673, dep: '18:25', dur: 280, ac: 'Boeing 737-800',   fare: 129, days:[6] },
    { code: 'WN', num:  673, dep: '13:45', dur: 280, ac: 'Boeing 737 MAX 8', fare: 131, days:[0] },
    { code: 'WN', num:  760, dep: '19:15', dur: 275, ac: 'Boeing 737 MAX 8', fare: 131, days:[1,4,5] },
    { code: 'WN', num: 1010, dep: '13:25', dur: 295, ac: 'Boeing 737 MAX 8', fare: 129, days:[6] },
    { code: 'WN', num: 1010, dep: '18:30', dur: 295, ac: 'Boeing 737 MAX 8', fare: 129, days:[0] },
    // ── 1-stop ────────────────────────────────────────────────────────────
    { code: 'AA', num: 1937, dep: '05:01', dur: 454, ac: 'Boeing 737-800',   fare:  87, stops: 1, via: 'DFW' },
    { code: 'AA', num: 1309, dep: '05:30', dur: 527, ac: 'Airbus A321',      fare:  84, stops: 1, via: 'DFW' },
    { code: 'AA', num: 2741, dep: '14:18', dur: 408, ac: 'Boeing 737-800',   fare:  87, stops: 1, via: 'DFW' },
    { code: 'AA', num:  814, dep: '09:05', dur: 443, ac: 'Boeing 737-800',   fare:  92, stops: 1, via: 'DFW' },
    { code: 'AA', num: 2104, dep: '12:30', dur: 460, ac: 'Airbus A321',      fare:  94, stops: 1, via: 'DFW' },
    { code: 'AA', num: 3652, dep: '16:50', dur: 485, ac: 'Boeing 737-800',   fare:  89, stops: 1, via: 'DFW' },
    { code: 'AA', num: 3086, dep: '07:15', dur: 462, ac: 'Boeing 737-800',   fare:  93, stops: 1, via: 'PHX' },
    { code: 'AA', num: 1418, dep: '07:20', dur: 398, ac: 'Airbus A319',      fare:  91, stops: 1, via: 'PHX' },
    { code: 'AA', num: 2853, dep: '11:45', dur: 420, ac: 'Boeing 737-800',   fare:  93, stops: 1, via: 'PHX' },
    { code: 'AA', num:  672, dep: '15:10', dur: 412, ac: 'Airbus A321',      fare:  95, stops: 1, via: 'PHX' },
    { code: 'AA', num: 1104, dep: '06:55', dur: 380, ac: 'Boeing 737-800',   fare:  96, stops: 1, via: 'LAX' },
    { code: 'AA', num: 3721, dep: '10:30', dur: 405, ac: 'Airbus A321',      fare:  94, stops: 1, via: 'LAX' },
    { code: 'AA', num: 2286, dep: '14:55', dur: 425, ac: 'Boeing 737-800',   fare:  92, stops: 1, via: 'LAX' },
    { code: 'AA', num:  531, dep: '08:15', dur: 460, ac: 'Airbus A321',      fare:  89, stops: 1, via: 'CLT' },
    { code: 'AA', num: 1864, dep: '17:35', dur: 490, ac: 'Boeing 737-800',   fare:  87, stops: 1, via: 'CLT' },
    { code: 'WN', num:  485, dep: '05:15', dur: 375, ac: 'Boeing 737-800',   fare:  74, stops: 1, via: 'PHX', days:[1,4,5] },
    { code: 'WN', num: 3239, dep: '05:00', dur: 375, ac: 'Boeing 737-800',   fare:  74, stops: 1, via: 'PHX', days:[0] },
    { code: 'WN', num:  540, dep: '07:35', dur: 395, ac: 'Boeing 737-700',   fare:  76, stops: 1, via: 'PHX', days:[0,5] },
    { code: 'DL', num: 2847, dep: '06:15', dur: 450, ac: 'Airbus A220-300',  fare:  87, stops: 1, via: 'SLC' },
    { code: 'UA', num: 3281, dep: '06:30', dur: 425, ac: 'Boeing 737-900',   fare:  82, stops: 1, via: 'IAH' },
    { code: 'UA', num: 2437, dep: '07:40', dur: 454, ac: 'Airbus A320neo',   fare:  84, stops: 1, via: 'DEN' },
    { code: 'F9', num: 2401, dep: '12:09', dur: 649, ac: 'Airbus A320neo',   fare:  69, stops: 1, via: 'DEN' },
  ],
